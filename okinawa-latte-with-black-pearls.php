...
// To check if a particular item has been added into cart, an if statement and under condition there's an isset function with the add_to_cart variable. 
if ( isset( $_POST[ "add_to_cart" ] ) ) {
  ...
  setcookie( "shopping_cart", $item_data, time() + ( 86400 * 15), "/" );
...
<title>Okinawa Latte with Black Pearls - Teaven</title>
</head>
<body>
...
<div class="row">
<div class="col">
  <div class="box"> <img src="img/bubbleTeaTwo.png"> </div>
</div>
<?php
...
$query = "SELECT * FROM teaven_teas WHERE bubble_id = 'b2'";
// Execute the query
