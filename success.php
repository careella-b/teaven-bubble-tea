...
<title>Confirmation - Teaven</title>
</head>
<body>
...
<div class="text-center py-5">
  ...
  <p>Thank you for your order!</p>
	 ...
	 <!-- Once the user clicks on this button the shopping will get rid of the old item(s) -->
    <button class="btn back-btn clear-btn btn-sm text-right">
    <a href="okinawa-latte-with-black-pearls.php?action=clear">Back to Basket</a>
</button>
</div>
</main>
<!-- End of main -->
