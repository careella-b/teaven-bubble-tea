...
<link href="continue.css" rel="stylesheet">
...
<div class="jumbotron jumbotron-fluid">
  <div class="container py-5">
    <div class="text-center py-5">
		<h1 class="animate-heading">SHOPPING <span class="one-word-colour">CART</sapn></h1>
    </div>
  </div>
</div>
<main>
	  ...
	  echo "
		<main>
		  <div class='container section'>
			<div class='row'>
			  <div class='col text-center return-cust'>
				<h2>Returning Customer</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer finibus urna quam, nec vehicula dui venenatis eu.</p>
				<a href='loginForm.php'>
				<button class='btn btn-default btn-lg submit-btn'>Login and Checkout</button>
				</a> </div>
			</div>
			<div class='row'>
			  <div class='col text-center new-cust'>
				<h2>New Customer</h2>
				<p>Nulla elementum congue dolor, non tempor lectus eleifend ac. Praesent ut aliquet risus.</p>
				<a href='registration.php'>
				<button class='btn btn-default btn-lg submit-btn'>Sign up and Checkout</button>
				</a> </div>
			</div>
			<div class='row'>
			  <div class='col text-center guest'>
				<h2>Guest Checkout</h2>
				<p>Maecenas laoreet ex eget congue dictum. In rhoncus interdum nunc, ut eleifend odio aliquet eu. Aliquam ac commodo arcu.</p>
				<a href='checkout.php'>
				<button class='btn btn-default btn-lg submit-btn'>Continue as Guest</button>
				</a> </div>
			</div>
		  </div>
		</main> 
