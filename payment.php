...
<!-- BILLING ADDRESS FORM -->
  <div class="col-md-8 order-md-1">
    ...
    <h5 class="text-center">Or pay by PayPal</h5>
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
      <input type="hidden" name="cmd" value="_xclick"> <!-- _xclick = The button that the person clicked was a Buy Now button -->
	...
	<!-- item_name, item_number, quantity and amount is dynamically link to the value from the shopping cart - using PHP code fetch and display data -->
      ...
      <input type="hidden" name="return" value="http://unn-w19015711.newnumyspace.co.uk/success?action=clear.php">
